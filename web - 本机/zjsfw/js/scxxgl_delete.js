...
function qd(){
    ...
    var scscid = scxxList[index].scscid; 
    // 发送请求
    var path = "http://localhost:8848/api/zjsfw/scxxgl/delete";
    $.ajax({
        url: path,
        type: "post",
        dataType: 'json',
        ...
        success: function(result) {
            if(result.msg=="success"){
                ...
                tips("删除成功！","./scxxgl_bg_many.html","中间商服务>收菜信息管理>删除收菜信息")
                window.location.href="./scxxgl_tips.html";
            }
            if(result.msg=="dbException"){
                tips("数据库异常!","./scxxgl_bg_many.html","中间商服务>收菜信息管理>删除收菜信息")
                window.location.href="./scxxgl_tips.html"
            }
        },
        error: function(result) {
            tips("服务器异常!","./scxxgl_bg_many.html","中间商服务>收菜信息管理>删除收菜信息")
            window.location.href="./scxxgl_tips.html";
        }
    });
}
