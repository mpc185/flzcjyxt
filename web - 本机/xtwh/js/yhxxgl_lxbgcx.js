...
function cx(){
    ...
    var path = "http://localhost:8848/api/xtwh/glyhxx/lxbgcx";
    $.ajax({
        url: path,
        type: "post",
        dataType: 'json',
        ...
        success: function(result) {
            if(result.msg=="success"){
                ...
                window.location.href="./yhxxgl_lxbg.html";
            }
            if(result.msg=="noInfo"){
                tips("不存在该用户!","./yhxxgl_lxbgcx.html","系统维护>管理用户信息>查询用户");
                window.location.href="./yhxxgl_tips.html";
            }
            if(result.msg=="dbException"){
                tips("数据库异常!","./yhxxgl_lxbgcx.html","系统维护>管理用户信息>查询用户");
                window.location.href="./yhxxgl_tips.html";
            }
        },
        error: function(result) {
            tips("服务器异常!","./yhxxgl_lxbgcx.html","系统维护>管理用户信息>查询用户");
            window.location.href="./yhxxgl_tips.html";
        }
    });
